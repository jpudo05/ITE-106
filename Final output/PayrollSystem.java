...
public class PayrollSystem extends JFrame implements ActionListener {
    ...
    public PayrollSystem() {
        Color primaryColor = new Color(42, 157, 143);
        Color secondaryColor = new Color(38, 70, 83);
        Color backgroundColor = new Color(233, 196, 106);
        Color darkBlueColor = new Color(38, 70, 83);
        Color lightPurple = new Color(168, 160, 215);
